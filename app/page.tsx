    ...
    <main className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
      <div className="max-w-4xl w-full space-y-12">
        <div className="text-center space-y-4">
          ...
          <p className="text-xl text-muted-foreground">Select a module to manage student competitions</p>
        </div>
              ...
              <div className="space-y-6 h-full flex flex-col justify-between">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <h2 className="text-3xl font-bold text-foreground">Early Classes</h2>
                    <p className="text-muted-foreground">Manage competitions for younger students</p>
                  </div>
                </div>
            ...
            <Card className="h-full p-8 hover:shadow-lg transition-all cursor-pointer border-primary/20 hover:border-primary/50 bg-card">
              <div className="space-y-6 h-full flex flex-col justify-between">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <h2 className="text-3xl font-bold text-foreground">Matured Classes</h2>
                    <p className="text-muted-foreground">Manage competitions for senior students</p>
                  </div>
                </div>
